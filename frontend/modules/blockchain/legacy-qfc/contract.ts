export const QFT_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_LEGACY_QFC_ADDRESS || process.env.NEXT_PUBLIC_QFC_ADDRESS || process.env.NEXT_PUBLIC_QFT_ADDRESS || "";
...
export const PAYMENT_CODE_HASH = process.env.NEXT_PUBLIC_LEGACY_PAYMENT_CODE_HASH || "";
export const PAYMENT_ABI = [
  "function pay(uint256 amount)",
  "function token() view returns (address)",
  "function treasury() view returns (address)",
  "function BURN_RATE_BPS() view returns (uint256)",
